                    ...
                    <Row className="details">
                        ...
                        <Col>
                            <Row>
                                <div className="detail">
                                    <b>Last Name:</b>
                                    {orderData.printful.recipient.name.split(' ').length > 1 ? orderData.printful.recipient.name.split(' ') : ''}
                                </div>
                            </Row>
                            <Row>
                                <div className="detail">
                            ...
                            <Row>
                                <div className="detail">
                                    <b>Street Adress:</b> {orderData.printful.recipient.address1 + ' / ' + orderData.printful.recipient.address2}
                                </div>
                            </Row>
                        </Col>
